                      ...
                      child: IconButton(
                        ...
                        onPressed: () {
                          Navigator.of(context)
                              .pushNamed(MainFavoriteScreen.routeName);
                        },
                      ),
                    ),
                  ),
...
//                      onPressed:
//                          cartProvider.getCartItems.contains(productId)  ? () {}
//
//                              : () {
...
//                ),
                ...
                //        onTap: () {
                //          favsProvider.fetchFavorites();
                //           // (productId,
                //            //  prodAttr.price, prodAttr.title, prodAttr.imageUrl);
                //        },
                //        child: Center(
                //          child: Icon(
                //            favsProvider.getFavorites.contains(productId)
                //                ? Icons.favorite
                //                : Icons.favorite,
                //            color:
                //                favsProvider.getFavorites.contains(productId)

...
import 'package:matgar_app/services/payment.dart';
                        ...
                        globalMethods.showDialogg(
                            ...
                            'Your cart will be cleared!',
                              ...
                              await FirebaseFirestore.instance
                                  .collection('cart').where('userId', isEqualTo: _uid).get().then((value) => value.docs.forEach((element) {

...
class _LandingPageState extends State<LandingPage>
  ...
  void initState() {
    super.initState();
    images.shuffle(); // تعمل على ترتيب العناصر داخل الليست بشكل عشوائي
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      CachedNetworkImage(
        ...
        // اذا صار في ايرور تظهر هذه الايقونة بدل السكرين
        fit: BoxFit.cover,
      ...
      Column(
        ...
        children: [
          ...
          // ازرار تسجيل الدخول login SignUP   =================================
          Row(
            children: [
              SizedBox(width: 10),
              Expanded(
          ...
          // ازرار تسجيل  الدخول  ك guest و google =========================================
